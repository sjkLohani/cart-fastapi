...
from schemas.cart_schemas import CartItemCreate, CartResponse, MessageResponse
...
def get_current_user_id(
    x_user_id: int = Header(..., description="logged-in User ID", gt=0),
):
    return x_user_id
...
@app.delete(
    "/cart/items/{product_id}", response_model=CartResponse, tags=["Cart Items"]
)
